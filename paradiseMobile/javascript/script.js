//My Javascript Code for Paradise Gardens App
$(document).ready(function() {
	$(document).on("pageshow", "[data-role='page']", function() {
		if($($(this)).hasClass("header_default")) {
			$('<header data-theme="b" data-role="header"><h1></h1><a href="#" class="ui-btn-left ui-btn-icon-notext ui-btn ui-btn-inline ui-mini ui-corner-all ui-icon-back" data-rel="back">Back</a><a href="#mydialog" class="ui-btn-right ui-btn-icon-notext ui-btn ui-btn-b ui-btn-inline ui-mini ui-corner-all ui-icon-info">Info</a></header>')
				.prependTo( $(this) )
...
function listPosts (data) {
	...
	$.each(data.posts, function(key, val) {
		...
		output += (val.thumbnail) ?
			...
			'<img src="images/ParadiseGardensLogo.png" alt="Paradise Logo">';
...
function jsonFlickrFeed(data) {
  ...
  for (var i=5; i < data.items.length; i++) {
	  if (i != 8) {
